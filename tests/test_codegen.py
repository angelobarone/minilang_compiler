...
class TestLLVMCodeGen(unittest.TestCase):
    ...
    def test_return_aritmetico(self):
        # return 10 + 5;
        expr = ast.BinaryExpr(
    ...
    def test_dichiarazione_variabili(self):
        # let x = 42; return x;
        stmts = [
    ...
    def test_chiamata_funzione_esterna(self):
        # extern func print(n);
        # func main() { print(10); }
